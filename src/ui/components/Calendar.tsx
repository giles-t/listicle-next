...
/*
 * Documentation:
 * Calendar — https://app.subframe.com/7b590a12c74e/library?component=Calendar_5a87e517-ace2-49af-adcf-076c97ec3921
 */
  ...
  return (
    <SubframeCore.Calendar
      ...
      classNames={{
        ...
        button_next:
          "inline-flex items-center justify-center h-8 w-8 bg-transparent rounded border-none bg-transparent hover:bg-neutral-50 active:bg-neutral-100 border-none",
        chevron: "text-[18px] font-medium leading-[18px] text-neutral-600",
