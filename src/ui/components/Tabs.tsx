  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        ...
        {
          "border-b-2 border-x-0 border-t-0 border-solid border-brand-600 px-2.5 pt-0.5 pb-px hover:border-b-2 hover:border-x-0 hover:border-t-0 hover:border-solid hover:border-brand-600":
            active,
        },
        className
      )}
