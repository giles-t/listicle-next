  ...
  return (
    <div className="flex w-full max-w-[576px] flex-col items-start gap-12 animate-pulse">
      <div className="flex w-full flex-col items-start gap-1">
        ...
        <div className="w-full max-w-md h-4 bg-neutral-200 rounded" />
      </div>
      <div className="flex w-full flex-col items-start gap-6">
        ...
        <div className="w-full h-14 bg-neutral-200 rounded" />
        <div className="w-full h-14 bg-neutral-200 rounded" />
        <div className="w-full h-24 bg-neutral-200 rounded" />
        <div className="w-full h-14 bg-neutral-200 rounded" />
      </div>
      <div className="flex w-full flex-col items-start gap-6">
      ...
      <div className="flex w-full items-center justify-end gap-2">
        <div className="w-24 h-10 bg-neutral-200 rounded" />
      </div>
    </div>
  );
} 