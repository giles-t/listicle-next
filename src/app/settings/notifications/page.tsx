    ...
    <div className="flex w-full max-w-[576px] flex-col items-start gap-12">
      ...
      <div className="flex w-full flex-col items-start gap-6">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <select
            className="w-48 h-10 border border-neutral-border rounded-md px-3 text-body font-body text-default-font outline-hidden focus:border-brand-600 focus:ring-1 focus:ring-brand-600 bg-default-background"
            defaultValue="sunday"
          >
