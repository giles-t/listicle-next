 ...
 * has no custom cover image (see `generateOGImageUrl` in
 * `src/shared/utils/metadata.ts`, wired up from the profile/list/publication
 * layouts).
 *
...
/**
 * Derive a (title, subtitle, meta) triple for each metadata caller. Keys
 * match the query params set by `generateOGImageUrl` in
