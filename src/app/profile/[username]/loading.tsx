      ...
      <div className="flex w-full max-w-[768px] flex-col items-start gap-12">
        ...
        <div className="flex w-full flex-col items-start gap-4 animate-pulse">
          ...
          <div className="flex w-full flex-col items-start gap-2">
            <div className="w-48 h-8 bg-neutral-200 rounded" />
            <div className="w-32 h-4 bg-neutral-200 rounded" />
            <div className="w-64 h-4 bg-neutral-200 rounded" />
            <div className="w-full max-w-md h-16 bg-neutral-200 rounded mt-2" />
          </div>
          <div className="flex gap-2">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="w-10 h-10 bg-neutral-200 rounded" />
            ))}
          </div>
        </div>
          ...
          <div className="flex w-full flex-wrap items-start gap-4">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="flex-1 min-w-[300px] max-w-[350px]">
                <div className="w-full h-48 bg-neutral-200 rounded-lg mb-3" />
